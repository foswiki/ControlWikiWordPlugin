...
our $SHORTDESCRIPTION = 'Stop or Force wikiword linking based upon rules.';
...
sub initPlugin {
    ...
    # like this:
    # $Foswiki::cfg{Plugins}{ControlWikiWordPlugin}{ExampleSetting} = 1;
    ...
    # my $setting = $Foswiki::cfg{Plugins}{ControlWikiWordPlugin}{ExampleSetting} || 0;
...
1;
__END__
This copyright information applies to the ControlWikiWordPlugin:

# Plugin for Foswiki - The Free and Open Source Wiki, http://foswiki.org/
#
# ControlWikiWordPlugin is # This program is distributed in the hope that it will be useful,
# but WITHOUT ANY WARRANTY; without even the implied warranty of
